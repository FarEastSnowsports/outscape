...
(function () {
  ...
  var COURSES = {
    shinsen: {
      ...
      difficulty: "Easy", duration: "~3 hrs", access: "Boardwalk", elevation: "+90 m",
    ...
    hangetsu: {
      ...
      level: "Easy", levelClass: "easy",
      difficulty: "Easy", duration: "~2.5 hrs", access: "Forest trail", elevation: "+80 m",
    ...
    usu: {
      ...
      difficulty: "Easy", duration: "~3 hrs", access: "Ropeway", elevation: "By ropeway",
    ...
    asahi: {
      ...
      level: "Easy", levelClass: "easy",
      difficulty: "Easy", duration: "~2 hrs", access: "Forest path", elevation: "+80 m",
    ...
    oyachi: {
      ...
      level: "Easy", levelClass: "easy",
      difficulty: "Easy", duration: "~2.5 hrs", access: "Lakeside", elevation: "+50 m",
    ...
    kagami: {
      ...
      difficulty: "Moderate", duration: "~3 hrs", access: "Mountain trail", elevation: "+200 m",
    ...
    shirakaba: {
      ...
      level: "Moderate", levelClass: "mod",
      difficulty: "Moderate", duration: "~3 hrs", access: "Ridge trail", elevation: "+250 m",
    ...
    annupuri_g: {
      ...
      difficulty: "Moderate", duration: "~3 hrs", access: "Gondola", elevation: "By gondola",
